...
@section('body')
    <?PHP
        $smtp_server_username = App\Http\Controllers\SettingController::simpleEncrypt($settings['smtp_server_username'], 'd');
        $smtp_server_password = App\Http\Controllers\SettingController::simpleEncrypt($settings['smtp_server_password'], 'd');
        $mailgun_secret = App\Http\Controllers\SettingController::simpleEncrypt($settings['mailgun_secret'], 'd');
        $mandrill_secret = App\Http\Controllers\SettingController::simpleEncrypt($settings['mandrill_secret'], 'd');
        $ses_key = App\Http\Controllers\SettingController::simpleEncrypt($settings['ses_key'], 'd');
        $ses_secret = App\Http\Controllers\SettingController::simpleEncrypt($settings['ses_secret'], 'd');
        $sparkpost_secret = App\Http\Controllers\SettingController::simpleEncrypt($settings['sparkpost_secret'], 'd');
    ?>
    {{--Start Content--}}
    <div class="section-wrapper">
        <div class="mg-t-40">
            <form method="post" action="{{route('mail.save.settings')}}" enctype="multipart/form-data">
                @csrf
                <div class="form-layout form-layout-4">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <select name="mail_driver" id="mail_driver" onChange="mail_driver_change()"
                                ...
                                <option value="mail" {{--{{($settings_q['mail_driver'] =='mail')?'selected':''}}--}}>
                                    Mail
                                </option>
                                <option
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="smtp_host_address" class="form-control "
                                   value="{{isset($settings['smtp_host_address'])?$settings['smtp_host_address']:""}}">
                        </div>
                    </div>
                    <div class="row mg-t-20">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="smtp_host_port" class="form-control "
                                   value="{{isset($settings['smtp_host_port'])?$settings['smtp_host_port']:""}}">
                        </div>
                    </div>
                    <div class="row mg-t-20">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="mail_encryption_protocol" class="form-control "
                                   value="{{isset($settings['mail_encryption_protocol'])?$settings['mail_encryption_protocol']:""}}">
                        </div>
                    </div>
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="smtp_server_username" class="form-control "
                                   value="{{isset($smtp_server_username)?$smtp_server_username:""}}">
                        </div>
                    </div>
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="smtp_server_password" class="form-control "
                                   value="{{isset($smtp_server_password)?$smtp_server_password:""}}">
                        </div>
                    </div>
                    ...
                    <div class="row mg-t-20 mailserver_mailgun">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="mailgun_domain" class="form-control"
                                   value="{{isset($settings['mailgun_domain'])?$settings['mailgun_domain']:""}}">
                        </div>
                    </div>
                    <div class="row mg-t-20 mailserver_mailgun">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="mailgun_secret" class="form-control "
                                   value="{{isset($mailgun_secret)?$mailgun_secret:""}}">
                        </div>
                    </div>
                    ...
                    <div class="row mg-t-20 mailserver_mandrill">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="mandrill_secret" class="form-control "
                                   value="{{isset($mandrill_secret)?$mandrill_secret:""}}">
                        </div>
                    </div>
                    ...
                    <div class="row mg-t-20 mailserver_ses">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="ses_key" class="form-control " value="{{isset($ses_key)?$ses_key:""}}">
                        </div>
                    </div>
                    ...
                    <div class="row mg-t-20 mailserver_ses">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="ses_secret" class="form-control " value="{{isset($ses_secret)?$ses_secret:""}}">
                        </div>
                    </div>
                    ...
                    <div class="row mg-t-20 mailserver_sparkpost">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="sparkpost_secret" class="form-control "
                                   value="{{isset($sparkpost_secret)?$sparkpost_secret:""}}">
                        </div>
                    </div>
